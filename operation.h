...
void matrice_trans_vecteur_imp(int space_scheme, std::vector<double>& U, std::vector<double>& result, int Nx, int Ny, double dx, double dy,double xmin, double ymin, double t, int cas, double dt);
